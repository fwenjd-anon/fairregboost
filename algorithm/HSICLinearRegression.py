from algorithm.FGLM_files.models import HSICLinearRegression

class HSICLinearRegressionClass():
    """
    information [...]
    ...
    def fit(self, X_train, y_train):
        ...
        self.model = HSICLinearRegression(sensitive_index=sens_idx, sensitive_predictor=False, lam=self.lam)
