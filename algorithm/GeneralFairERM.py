from algorithm.FGLM_files.models import GeneralFairERM

class GeneralFairERMClass():
    """
    information [...]
    ...
    def fit(self, X_train, y_train):
        ...
        self.model = GeneralFairERM(sensitive_index=sens_idx, sensitive_predictor=False, eps=self.eps, K=10)
