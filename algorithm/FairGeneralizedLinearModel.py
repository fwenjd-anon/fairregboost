from algorithm.FGLM_files.models import FairGeneralizedLinearModel
...
class FairGeneralizedLinearModelClass():
    ...
    def fit(self, X_train, y_train):
        ...
        self.model = FairGeneralizedLinearModel(sensitive_index=sens_idx, sensitive_predictor=False, lam=self.lam, family="normal", discretization=self.discretization, tol=1e-4)
